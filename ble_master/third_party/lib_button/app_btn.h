...
#define APP_BTN_SCAN_PERIOD_MS (20 * CLOCK_SYS_TIMER_CLK_1MS)
#endif

#ifndef APP_BTN_ON_HOLD_TIME_FIRE_EVENT_MS
#define APP_BTN_ON_HOLD_TIME_FIRE_EVENT_MS (5 * CLOCK_SYS_TIMER_CLK_1S) 
#endif

#ifndef APP_BTN_HOLD_SO_LONG_TIME_MS
#define APP_BTN_HOLD_SO_LONG_TIME_MS (10 * CLOCK_SYS_TIMER_CLK_1S) 
#endif

#ifndef APP_BTN_DOUBLE_CLICK_TIME_MS
#define APP_BTN_DOUBLE_CLICK_TIME_MS (1 * CLOCK_SYS_TIMER_CLK_1S)
#endif
