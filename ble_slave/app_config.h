...
#define FACTORY_ID_L 	0x11
#define FACTORY_ID_M	0x30

#define FACTORY_TAG     0x01
#define VALUE_TAG       0x02


/* ========================================================================================== */

///////////////////////// Feature Configuration////////////////////////////////////////////////
#define BLE_WHITELIST_ENABLE							USER_BLE_WHITELIST_ENABLE
#define BLE_APP_PM_ENABLE								USER_PM_ENABLE
#define PM_DEEPSLEEP_RETENTION_ENABLE					USER_DEEPSLEEP_RETENTION_ENABLE
#define TEST_CONN_CURRENT_ENABLE            			0 	//test connection current, disable UI to have a pure power
#define BLE_APP_SECURITY_ENABLE      					USER_BLE_APP_SECURITY_ENABLE	//ACL Slave device SMP, strongly recommended enabled
#define BLE_OTA_SERVER_ENABLE							USER_BLE_OTA_ENABLE
...
#define UART_PRINT_DEBUG_ENABLE				USER_UART_PRINT_DEBUG_ENABLE
#define APP_LOG_EN							1
